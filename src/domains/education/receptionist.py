"""
Education Receptionist — Concrete Implementation
...
class EducationReceptionist(Receptionist):
    """
    ...
    Architecture:
        ...
        Tools: course lookup, admission status, campus visit scheduling,
               fee inquiry, FAQ search.
    """
    ...
    async def handle_call_start(self, session_id: str, caller: str, called: str) -> str:
        """Initialise session and return education-specific greeting."""
    ...
    async def handle_transcript(self, session_id: str, transcript: str) -> str:
        ...
        # Build context with education-specific prompt
        messages = build_education_prompt(
