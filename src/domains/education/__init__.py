"""
Education Domain Plugin for the Voice Agent Platform.

Exports the EducationDomain implementation for registration with
...
from .domain import EducationDomain
