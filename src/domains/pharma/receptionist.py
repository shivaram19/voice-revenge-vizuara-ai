"""
Pharma Receptionist — Concrete Implementation
...
class PharmaReceptionist(Receptionist):
    """
    ...
    Architecture:
        ...
        Tools: drug information, prescription status check, refill request,
               adverse event reporting, FAQ search.
    """
    ...
    async def handle_call_start(self, session_id: str, caller: str, called: str) -> str:
        """Initialise session and return pharmacy-specific greeting."""
    ...
    async def handle_transcript(self, session_id: str, transcript: str) -> str:
        ...
        # Build context with pharmacy-specific prompt
        messages = build_pharma_prompt(
