...
var commonTags = {
  project: 'trelolabs-voice-agent'
  environment: environment
  managedBy: 'bicep'
  costCenter: 'engineering'
}

var baseName = 'trelolabs-${environment}'
  ...
  properties: {
    ...
    template: {
      containers: [
        {
          name: 'receptionist'
          image: '${acr.properties.loginServer}/voice-agent:latest'
          resources: {
          ...
          env: [
            ...
            { name: 'COMPANY_NAME', value: 'TreloLabs Voice AI' }
